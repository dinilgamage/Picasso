    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card rounded">
                <div class="card-header fw-bolder lead" style="background-color: #933800; color:#FFBB07">{{ __('Register') }}</div>

                <div class="card-body shadow-lg" style="background-color: antiquewhite;">
